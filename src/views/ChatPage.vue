<template>
  <div class="page" id="page-chat">
    ...
    <CommonHeader>
      ...
      <template #right>
        <div class="flex-1 flex justify-end">
          <button class="nav-action text-sm text-gray mr-3">
            <i class="fa fa-video-camera"></i>
          </button>
          <button class="nav-action text-sm text-gray">
    ...
    <!-- 聊天内容区 -->
    <div
      class="px-3 pb-3 pt-16 space-y-4 overflow-y-auto flex-1"
      id="chat-messages"
    >
      <!-- 系统消息 -->
      ...
      <div class="flex items-start justify-end">
        <div class="mr-2 max-w-[70%] text-right">
          <div
            class="bg-primary text-white rounded-lg rounded-tr-none p-2 text-sm"
          >
            你好，我想了解一下课程的具体内容和价格
          </div>
    ...
    <div class="bg-light border-t border-gray-100 p-3">
      ...
      <div class="flex items-center">
        ...
        />
        <button
          class="ml-2 bg-primary text-white rounded-full w-9 h-9 flex items-center justify-center"
        >
