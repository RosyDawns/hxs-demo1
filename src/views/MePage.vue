<template>
  <div
    class="page flex flex-col h-screen bg-gray-50"
    id="page-me"
  ...
  >
    ...
    <header class="p-3 flex items-center justify-between">
      <button
        class="flex items-center text-sm px-3 py-1.5 border border-gray-300 rounded-full nav-action bg-white"
