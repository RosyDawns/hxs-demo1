<template>
  <div class="px-4 pb-4 pt-0">
    <div class="text-xl font-bold mb-2 text-center">深夜不睡，熬肉煮腱胖!</div>
    <!-- 睡眠打卡宣传卡片 -->
    <div
      class="bg-gradient-to-r from-blue-400 to-cyan-400 rounded-xl p-6 text-white text-center mb-4"
    >
